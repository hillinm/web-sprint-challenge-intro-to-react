...
React JS is a javascript library used to build interactive elements on websites.  React JS makes application load times faster by using the virtual DOM.  Examples of apps using React are Twitter, Facebook, and Quora.

2. Describe component state.

State is an object that determines how a component renders and behaves.  State has props that React Components use.

3. Describe props.

Props are properties that are used in React Components.

4. What are side effects, and how do you sync effects in a React component to changes of certain state or props?

Side effects affect anything outside the scope of the current function. 
